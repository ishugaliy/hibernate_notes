...
INSERT INTO customer(ID,FIRST_NAME,LAST_NAME,STREET,APPT,CITY,ZIP_CODE,EMAIL,LAST_UPDATED_TIME)
	VALUES (100,'Jupiter','Jone','10 Downing Street','123','London','12345', 'j@nobody.com', current_timestamp);

INSERT INTO orders(ID, CUST_ID,TOTAL_PRICE,OREDER_DESC,ORDER_DATE,LAST_UPDATED_TIME)
	VALUES (333, 100,100,'Internet and phone',current_timestamp,current_timestamp);

INSERT INTO product(ID,PROD_NAME,PROD_DESC,REGULAR_PRICE,LAST_UPDATED_TIME)
	VALUES (2000,'A','Product A',60, current_timestamp);

INSERT INTO product(ID,PROD_NAME,PROD_DESC,REGULAR_PRICE,LAST_UPDATED_TIME)
	VALUES (2010,'B','Product B',30, current_timestamp);

INSERT INTO order_detail(ORDER_ID,PROD_ID)
	VALUES (333,2010);
